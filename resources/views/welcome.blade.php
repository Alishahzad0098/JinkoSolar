    ...
    <div class="container form-card col-lg-6 col-md-8 col-sm-12">
        <div class="card shadow-lg mx-auto" style="max-width: 500px;">
            <div class="card-body p-4">
                ...
                <hr>
                <h5>Dear users, you can identify the authenticity of the product by entering the module's serial number</h5>
                ...
                <form action="{{ route('search.module') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="serial" id="serial" class="form-control" placeholder="Enter serial number" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="captcha_input" class="form-control" placeholder="Enter the code above" required>
                        @error('captcha_input')
